...
export default function Index() {
  ...
  return (
    <HeaderLayout
      headerProps={{ className: isMobile() ? "" : "border-b border-black" }}
    >
      <div className="flex items-center w-container mx-auto justify-between text-2xl my-[5.375rem] md:flex-col-reverse md:w-full md:text-base">
        <div className="md:text-center md:mt-6">
          <h2 className="text-[2.75rem] font-bold text-green leading-[3.75rem] md:text-[1.75rem]">
            {t("contact")}
          </h2>
          ...
          <p className="mt-6 md:mt-4">{t("email")}：hi@gtech.world</p>
          <p className="mt-6 md:mt-4">{t("url")}：https://gtech.world</p>
        </div>
