  ...
  return (
    <div className="flex flex-col items-center w-full pt-16 bg-bgc md:pt-8 md:pb-4">
      <h3 className="text-center">
        <span className="text-green">{t("technologies.title.yellow")}</span> {t("technologies.title.text")}
      </h3>
...
function Assistance() {
  ...
  const btnList = [
    ...
    },
    {
      ...
      url: "https://aicp.gtech-cn.co/",
      className: i18n.language === "en" ? "w-[19.7rem]" : "w-[17.7rem]",
    },
    {
      text: t("assistance.btnList.products"),
      url: "https://aicp.gtech-cn.co/login",
      className: i18n.language === "en" ? "w-[15.7rem]" : "w-[17.7rem]",
    },
  ];
...
function CrossSolutions() {
  ...
  return (
    <div className="flex flex-col items-center pb-32 mt-20 md:mt-8 md:pb-12">
      ...
      <p className="text-center mt-5 max-w-[56.25rem] md:px-3">{t("crossSolutions.text")}</p>
          ...
          return (
            <div
              ...
              <div className="w-[35rem] md:w-full md:text-center md:mt-8">
                ...
                <p className={classNames("mt-5", v.layout === "left" ? "w-[36.5rem] md:w-full" : "")}>{v.text}</p>
                <AButton href={v.url} text={t("crossSolutions.list.button")} className="mt-8 w-[19.25rem]" />
              </div>
            </div>
          );
        })}
