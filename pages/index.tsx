    ...
    <div className="w-full relative bg-[url(/images/home_banner.jpg)] bg-no-repeat bg-center bg-cover">
      ...
      <div className="relative flex flex-col items-center">
        <div className="flex flex-col items-center font-bold text-shadow text-[4rem] leading-normal text-center md:text-[1.75rem]">
          <span className="mt-64 text-green-4 md:mt-36 ">
            {t("banner.text1")}
          </span>
          <span className="text-white">{t("banner.text2")}</span>
        </div>
        <div className="max-w-[34rem] text-white h-14 text-lg text-center mt-[14.375rem] mb-5 md:text-sm md:mt-[8.375rem] md:mb-9 md:px-6">
          {t("banner.tips")}
        </div>
        <img
          alt=""
          className="pb-3 md:hidden"
          src="images/home_head_arrow.svg"
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col items-center w-full pt-16 bg-bgc md:pt-8 md:pb-4">
      <h3 className="text-center">
        <span className="text-green">{t("technologies.title.yellow")}</span>{" "}
        {t("technologies.title.text")}
      </h3>
      <div className="max-w-[59.75rem] md:px-3 text-center mt-5">
        {t("technologies.text")}
      </div>
      <ul className="flex justify-between mt-20 w-container md:flex-col md:mt-16 md:w-full">
        {data.map((v, i) => {
          return (
            <li
              key={`technologies${i}`}
              className="flex flex-col items-center pb-16 md:pb-12"
            >
              <img className="h-[8rem] md:h-[6.125rem]" src={v.image} alt="" />
              <h6 className="mb-5 text-xl font-bold text-center text-green mt-7 md:text-base">
                {v.title}
              </h6>
              <p className="w-[19.375rem] text-lg md:text-sm md:text-center">
                {v.text}
              </p>
            </li>
          );
...
function Assistance() {
  ...
  const btnList = [
    {
      text: t("assistance.btnList.about"),
      url: "/solutions/automotive",
      className: i18n.language === "en" ? "w-[19.7rem]" : "w-[17.7rem]",
    },
    {
      text: t("assistance.btnList.aiag"),
      url: "https://aiag.org.cn/ACAC/Automotive-Carbon-Advisory-Committee",
      className: i18n.language === "en" ? "w-[15.7rem]" : "w-[17.7rem]",
    },
    {
      text: t("assistance.btnList.platform"),
      url: "https://aicp.gtech.world/",
      className: i18n.language === "en" ? "w-[19.7rem]" : "w-[17.7rem]",
    },
    {
      text: t("assistance.btnList.products"),
      url: "https://aicp.gtech.world/login",
      className: i18n.language === "en" ? "w-[15.7rem]" : "w-[17.7rem]",
    },
  ];
  ...
  return (
    <div className="mx-auto w-container md:w-full md:px-3">
      <h3 className="mt-16 mb-20 text-center text-green md:mt-8 md:mb-5">
        {t("assistance.title")}
      </h3>
      <div className="flex md:flex-col">
        <div className="min-w-[32.825rem] md:min-w-full rounded-lg overflow-hidden h-80 md:h-[13.375rem] bg-[url(/images/solution_intro.png)] bg-no-repeat bg-center bg-cover"></div>
            ...
            <Trans
              ...
              components={[
                <a
                  ...
                  key="info1"
                ></a>,
                <strong className="text-green" key="info2"></strong>,
                <sup className="font-bold text-green" key="info3"></sup>,
              ]}
            >
              {t("assistance.text")}
            </Trans>
          ...
          return (
            <div
              ...
              className={classNames(
                "mt-20 flex justify-between md:mt-12",
                v.layout === "left" ? "" : "flex-row-reverse",
                "md:flex-col"
              )}
            >
              <div className="md:mx-auto">
                <img
                  className="block w-[35rem] rounded-lg overflow-hidden md:max-w-full"
                  src={v.imgUrl}
                  alt=""
                />
              </div>
              <div className="w-[35rem] md:w-full md:text-center md:mt-8">
                ...
                <p
                  className={classNames(
                    "mt-5",
                    v.layout === "left" ? "w-[36.5rem] md:w-full" : ""
                  )}
                >
                  {v.text}
                </p>
