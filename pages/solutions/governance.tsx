...
function Top() {
  ...
  return (
    <div className="h-[44.625rem] text-white w-full bg-[url(/images/governance_banner.jpg)] bg-no-repeat bg-cover bg-center flex justify-center items-center px-9 md:h-[28rem]">
      <div className="bg-blue-1/[.8] flex flex-col justify-center w-[58.5rem] px-8 py-10 h-[13.125rem] text-[2rem] leading-[2.75rem] md:text-lg md:text-center md:px-4 md:py-11 md:w-auto md:h-auto">
...
function PowerManagement() {
  ...
  return (
    <div className="flex flex-col items-center pb-16 bg-bgc md:pb-8">
      <h3 className="w-[61.5rem] my-16 text-center leading-[65px] md:leading-6 md:w-full md:my-8 md:px-12">
        {t("powerManagement.title")}
      </h3>
      <div className="flex flex-col w-container md:w-full">
        <div className="h-[13rem] bg-[url(/images/industrial.svg)] bg-no-repeat bg-center"></div>
        <div className="mt-11 md:px-3 md:text-center md:mt-8">
          <p className="mb-5">{t("powerManagement.text1")}</p>
          <p>{t("powerManagement.text2")}</p>
        </div>
      </div>
    </div>
  );
...
function GreenData() {
  ...
  return (
    <div className="flex flex-col items-center w-full pt-16 pb-20 md:py-8">
      <h3 className="px-12 text-center">
        <span className="text-green">{t("greenData.title.green")}</span> <span>{t("greenData.title.text")}</span>
      </h3>
      <div className="flex mt-20 md:flex-col-reverse md:mt-8">
        <div className="w-[38.625rem] mr-[5.75rem] md:w-full md:text-center md:px-3">
          <h4 className="text-[1.75rem] leading-[32px] font-bold mb-10 md:text-base">
            {t("greenData.item1.subtitle")}
          </h4>
        ...
        <img
          className="w-[30.625rem] mx-auto md:max-w-[18.375rem] md:w-full md:mb-8"
      ...
      <div className="flex mt-24 md:flex-col md:mt-12">
        <div className="flex flex-col md:flex-col-reverse">
          <h4 className="text-[1.75rem] font-bold mb-8 md:text-base md:text-center md:mt-8">
            {t("greenData.item2.subtitle")}
          </h4>
