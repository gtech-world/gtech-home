    ...
    <HeaderLayout hiddenHeader={isMobile()} headerProps={headerProps}>
      ...
      <div className="mx-auto w-container md:w-full md:px-3 md:mt-2">
        <header className="pb-8 border-b border-gray-10 md:pb-5">
          ...
          <div className="flex flex-row items-center pt-2.5 md:w-[187px] flex-wrap">
            <span className="text-gray-1 text-[16px]">{type}</span>
            <time className="inline-block ml-5 text-gray-1 md:text-sm">{article.time}</time>
            <div className="flex flex-row  ml-5 md:ml-0 md:mt-2 md:h-[24px]">
              <span className="mr-5 border   rounded-[0.25rem] px-[10px] text-[#29953A] text-[14px]  bg-[#29953A1A]">
                {name}
              </span>
            </div>
          </div>
