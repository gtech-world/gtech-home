...
export function QrGroup(p: any) {
  ...
  return (
    <div className={classNames('w-[18.875rem] mx-auto md:w-full md:max-w-[22rem]',className)}>
      <div className={classNames("py-2 rounded-[2.25rem] outline outline-[5px] outline-green outline-offset-4 border-[1.75px] border-green flex justify-center items-center mr-[8px]")}>
        ...
        <div className="w-[7.125rem] flex flex-col items-center">
          <p className="text-[0.6875rem] text-center mb-2 leading-[1rem]">{qrText?qrText:'Product Carbon Footprint Certified by AIAG'}</p>
