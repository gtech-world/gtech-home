...
export default function Index() {
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex mt-10 w-[75rem] md:w-[21.9375rem]  mx-[155px] md:ml-[10.5px]  rounded-lg shadow-lg justify-between">
        {newsType.map((e) => {
          return (
            <div
              key={`type_${e.id}`}
              className="w-[360px] h-[12.75rem] md:w-[10.625rem] rounded-lg shadow-lg  md:mr-[10.5px] "
            >
