...
const tempList = [
  ...
  { url: "/images/frame.png", id: 2 },
  { url: "/images/three.png", id: 3 },
        ...
        <div className=" flex flex-wrap md:ml-5   md:mr-[2.5 md:mx-0 rem] mt-10 md:ml-[20px] rounded-lg shadow-lg justify-between">
          {newsType.map((e, index) => {
            return (
              ...
              `}>
                <div className="flex flex-row items-center justify-between w-full mr-5">
                  <div className=" ml-[1.875rem] text-white md:text-[18px]">{e.typeGroup}</div>
