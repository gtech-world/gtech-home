              ...
              <div className="flex flex-col justify-between md:ml-[10px]">
                <div className="">
                  ...
                  <div className="flex flex-row mt-[10px] md:h-[24px]" >{v?.newsTypes.map((e)=>{
                    return  <div className="mr-5 border md:h-[24px]  rounded-lg px-[10px] text-[#29953A] text-[14px]  bg-[#29953A1A]">{e.typeName}</div>
                  })}</div>
        ...
        <div className=" flex flex-wrap md:ml-5   md:mr-[2.5 md:mx-0 rem] mt-10 md:ml-[20px] rounded-lg justify-between">
          {newsType.map((e, index) => {
            return (
              ...
              `}>
                <div className="flex flex-row items-center justify-between w-full mr-[20px] ">
