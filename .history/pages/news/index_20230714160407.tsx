  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex flex-col  mx-[155px] md:mx-0 ">
        <div className=" flex flex-wrap bg-red-500   md:mx-0 rem] md-w-full mt-10 md:ml-[20px] rounded-lg justify-between">
          {newsType.map((e, index) => {
            return (
              <div
                key={`type_${e.id}`}
                className={`w-[170px] bg-red-300 h-[12.75rem]   rounded-lg shadow-lg   md:mr-[25px] ${index === 2 ? 'md:w-full md:mt-5  ' : 'md:w-[10.625rem] '
                  }`}
              >
