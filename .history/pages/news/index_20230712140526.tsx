...
export default function Index() {
  ...
  return (
    ...
    <div className="flex flex-wrap w-[41.875rem] md:w-[32.25rem] mx-40 md:mx-5 rounded-lg shadow-lg">
      <div className="w-[22.5rem] h-[12.75rem] md:w-[15.625rem] rounded-lg shadow-lg  md:mr-[2.25rem] ">
      ...
      <div className="w-[22.5rem] h-[12.75rem] md:w-[32.25rem] rounded-lg shadow-lg">Box 3</div>
    </div>
