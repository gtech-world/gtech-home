                  ...
                  {e.children.map((item: NewsTypesController.ListRecord) => {
                    ...
                    return (
                      ...
                      onClick={()=>setSelected(item)}
                        className={` ${selected.typeName === item.typeName ? 'md:w-full md:mt-5  ' : 'md:w-[10.625rem] '} bg-[#E9E9E9] min-w-[20px] h-[38px] flex items-center ml-5 mt-5 rounded-[0.25rem] px-[1rem]`}
                      >
                        {item.typeName}
                      </div>
                    );
