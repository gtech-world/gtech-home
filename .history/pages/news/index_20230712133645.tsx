...
export default function Index() {
  ...
  return (
    ...
    <div className="flex flex-wrap w-[67.5rem] md:w-[45rem] mx-40 md:mx-5">
      <div className="w-[22.5rem] h-[12.75] md:w-[16.25rem] bg-rose-300">
        <div>数字双碳</div>
      </div>
      <div className="w-[22.5rem] h-[12.75] md:w-[16.25rem]">box2</div>
      <div className="w-[22.5rem] h-[12.75] md:w-[22.5rem]">Box 3</div>
    </div>
