  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      ...
      <div className="flex flex-row">
        <img className=" w-[310px] h-[200px]" src='https://mmbiz.qpic.cn/mmbiz_jpg/DQUwqx2bH15GbMu8PU0kGXj8AAWqVIKMsPqnFjhq56jDIicHdpvZJ9ZZud3GAVeNV9NJu4bcMEtib0nZHAUmZaNA/0?wx_fmt=jpeg'></img>
        <div className=" ml-[32px]">
          <div>
            零知识证明101
          </div>
           探头探脑  2023-03-01 17:08
          <div>
          零知识证明（Zero-knowledge Proof，简称ZKP）是一种密码学技术，它允许证明某个命题是正确的，而无需透露任何关于这个命题的实际信息。简单来说，零知识证明可以让你证明你拥有某些秘密信息，而无需透露这些信息的任何细节。
          </div>
          <div>
           数字碳知识库
          </div>
