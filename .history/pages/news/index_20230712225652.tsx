      ...
      <div className="flex mt-10 w-[75rem] md:w-[21.9375rem]  mx-[155px] md:mx-5 rounded-lg shadow-lg justify-between">
        {newsType.map((e) => {
          return (
            <div
              key={`type_${e.id}`}
              className="w-[360px] h-[12.75rem] md:w-[10.625rem] rounded-lg shadow-lg flex-wrap flex md:mr-[1.25rem] "
            >
              <div className="shadow-lg w-full rounded-t-md  bg-green h-[4.25rem] flex items-center">
