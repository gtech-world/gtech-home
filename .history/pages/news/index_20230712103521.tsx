...
export default function Index() {
  ...
  return(
    <HeaderLayout headerProps={headerProps}>
      <div>
        <div className='max-w-sm flex-column ml-[9.5rem] mt-10 mx-10 bg-white shadow-lg h-[12.75rem] w-[22.5rem] rounded-xl sm:flex sm:space-y-0 sm:space-x-6'>
          <div className="w-full h-[3.75rem] p-4 bg-green-1 shadow-lg  text-white">数字双碳</div>
          <div className="w-full">数字碳知识库</div>
        </div>
      </div>
      {/* <Top />
