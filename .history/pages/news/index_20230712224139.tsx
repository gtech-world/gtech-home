...
export default function Index() {
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex  w-[75rem] md:w-[21.9375rem] mx-[150px] md:mx-5 rounded-lg shadow-lg">
        {newsType.map((e) => {
          return (
            <div
              key={`type_${e.id}`}
              className="w-[360px] h-[12.75rem] md:w-[10.625rem] rounded-lg shadow-lg flex justify-between md:mr-[1.25rem] "
            >
