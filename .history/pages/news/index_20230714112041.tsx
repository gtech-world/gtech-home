...
function ArticleList(p: { data: any[]; cateId: number }) {
  ...
  return (
    ...
    <div className="mt-16 w-container md:w-full md:mt-8 md:px-3 bg-red">
      {!!data.length &&
        data.map((v, i) => {
          ...
          return (
            ...
            <div
              key={`data${i}`}
              className="flex mb-12 bg-red-200 md:items-center md:mb-5   h-[200px]"
            >
              <div
                className={"max-w-[25rem] w-full md:max-w-[7.375rem] h-[16.125rem] md:h-[4.875rem] rounded-lg overflow-hidden"}
              >
              ...
              <div className="flex flex-col justify-between mr-11 md:ml-2.5">
                <div className="">
