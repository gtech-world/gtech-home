  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex  w-[75rem] md:w-[21.9375rem] mx-40 md:mx-5 rounded-lg shadow-lg">
        {newsType.map((e) => {
          return <div className="w-[22.5rem] h-[12.75rem] md:w-[10.625rem] rounded-lg shadow-lg mr-[3.75rem] md:mr-[1.25rem] ">
            <div className="shadow-lg rounded-t-md bg-green h-[4.25rem]">
              <div className=" ml-[1.875rem] flex justify-items-center">
                {e.typeGroup}
              </div>
            </div>
          </div>
