...
export default function Index() {
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div  style={{display:'flex',flexWrap:'wrap'}} className="flex mt-10 w-[75rem] md:w-[21.9375rem] whitespace-pre-line  mx-[155px] md:ml-[20px]  rounded-lg shadow-lg justify-between ">
        {newsType.map((e) => {
          return (
            <div
              key={`type_${e.id}`}
