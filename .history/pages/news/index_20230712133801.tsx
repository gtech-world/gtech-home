...
export default function Index() {
  ...
  return (
    ...
    <div className="flex flex-wrap w-[67.5rem] md:w-[45rem] mx-40 md:mx-5 rounded-lg shadow-lg">
      <div className="w-[22.5rem] h-[12.75rem] md:w-[16.25rem]rounded-lg shadow-lg bg-rose-300">
        <div className="rounded-lg shadow-lg bg-green">数字双碳</div>
        dasda
      </div>
      <div className="w-[22.5rem] h-[12.75rem] md:w-[16.25rem]">box2</div>
      <div className="w-[22.5rem] h-[12.75rem] md:w-[22.5rem]">Box 3</div>
    </div>
