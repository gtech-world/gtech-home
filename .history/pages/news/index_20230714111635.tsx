...
function ArticleList(p: { data: any[]; cateId: number }) {
  ...
  return (
    <>
    <div className="mt-16 w-container md:w-full md:mt-8 md:px-3 bg-red h-[342px]">
      {!!data.length &&
        data.map((v, i) => {
          ...
          return (
            ...
            <div
              key={`data${i}`}
              className="flex mb-12  md:items-center md:mb-5   h-[200px]"
            >
              <div
              ...
              <div className="flex flex-col justify-between ml-8 md:ml-2.5">
                <div className="">
                  ...
                  <div className="mt-[0.625rem] md:hidden">
                  <Link
