  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex flex-col  mx-[155px] md:mx-0 ">
        ...
        <div className="ml-[10px]" onClick={()=>setChecked(!checked)} >
       { checked ?<img className="h-[10px] " src={'/images/checked_top.svg'}></img>
        :<img className="h-[10px] " src={'/images/checked_bottom.svg'}></img>
       }
