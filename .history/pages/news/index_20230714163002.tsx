        ...
        <div className=" flex flex-wrap md:ml-5   md:mr-[2.5 md:mx-0 rem] mt-10 md:ml-[20px] rounded-lg justify-between">
          {newsType.map((e, index) => {
            return (
              <div
                key={`type_${e.id}`}
                className={`w-[360px]  h-[12.75rem]  rounded-lg shadow-lg   md:mr-[25px] ${index === 2 ? 'md:w-full md:mt-5  ' : 'md:w-[10.625rem] '
                  }`}
              >
                <div className={`  rounded-t-md  bg-green h-[68px] md:w-50px flex items-center
              ...
              `}>
                  <div className="flex flex-row items-center justify-between w-full mr-[12px] ">
                    ...
                    <div className="flex justify-end" >
                      ...
                      <img className=" w-[59px] h-[49px] md:w-[35px] md:h-[29px]" src={tempList[index].url} />
                    </div>
                  </div>
                </div>
                ...
                <div className='flex flex-row flex-wrap'>
                  {e.children.map((item: NewsTypesController.ListRecord) => {
                    ...
                    return (
                      <div
                        onClick={() => {setSelected(item);setChecked(false)}}
        ...
        <div className="mt-5 ">
          <div className="h-[26px] md:ml-5 md:border-b flex flex-row items-center">
            ...
            <div className="ml-[10px]" onClick={() => onCheck()} >
              {checked ? <img className="h-[13px] " src={'/images/checked_top.svg'}></img>
                : <img className="h-[13px] " src={'/images/checked_bottom.svg'}></img>
              }
