...
export default function Index() {
  ...
  return (
    ...
    <div className="flex flex-wrap w-[22.5rem]">
      <div className="w-[22.5rem] md:w-[16.25rem]">Box 1</div>
      <div className="w-[22.5rem] md:w-[16.25rem]"><div className="bg-black ">box 2</div></div>
      <div className="w-[22.5rem] md:w-[22.5rem]">Box 3</div>
    </div>
