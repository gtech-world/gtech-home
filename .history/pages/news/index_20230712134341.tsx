...
export default function Index() {
  ...
  return (
    ...
    <div className="flex flex-wrap w-[67.5rem] md:w-[21.815rem] mx-40 md:mx-5 rounded-lg shadow-lg">
      <div className="w-[22.5rem] h-[12.75rem] md:w-[10.25rem] rounded-lg shadow-lg mx-3">
        <div className="shadow-lg rounded-t-md bg-green">数字双碳</div>
        dasda
      </div>
      <div className="w-[22.5rem] h-[12.75rem] md:w-[10.25rem] rounded-lg shadow-lg">box2</div>
