...
<div className="flex w-[32.5rem] mx-10 px-10">
<div className="w-[22.5rem] md:w-[10.25rem] h-[3.75rem]  bg-green-1 shadow-lg  rounded-lg text-white">
            数字双碳
          </div>
          <div className="w-[22.5rem] md:w-[10.25rem] h-[3.75rem]  bg-green-1 shadow-lg  rounded-lg text-white">
            数字双碳
...
<div className="w-[22.5rem] md:w-[16.25rem] h-[3.75rem]  bg-green-1 shadow-lg  rounded-lg text-white">
            数字双碳
          </div>
