  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex max-w-4xl">
        <div className="w-72 md:w-48  mt-10 mx-10 bg-white shadow-lg h-[12.75rem]  rounded-lg  ">
          <div className="w-full h-[3.75rem]  bg-green-1 shadow-lg  rounded-lg text-white">
            数字双碳
          </div>
        ...
        <div className="w-72 md:w-48  mt-10 mx-10 bg-white shadow-lg h-[12.75rem]  rounded-lg  sm:space-y-0 ">
          <div className="w-full h-[3.75rem]  bg-green-1 shadow-lg  rounded-lg text-white">
            数字双碳
          </div>
          <div className="flex justify-between w-full p-2">
