...
<div className="flex flex-wrap w-[75rem] md:w-[21.9375rem] mx-40 md:mx-5 rounded-lg shadow-lg">
      {newsType.map((e)=>{
        return   <div className="w-[22.5rem] h-[12.75rem] md:w-[10.625rem] rounded-lg shadow-lg mr-[3.75rem] md:mr-[1.25] ">
          <div className="shadow-lg rounded-t-md bg-green">{e.typeGroup}</div>
          dasda
        </div>
