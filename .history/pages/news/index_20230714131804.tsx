...
export default function Index() {
  ...
  const isExist = JSON.stringify(selected) === '{}' ?  newsType[0].id :selected.id
  ...
  const getList =async () =>{
    const res = await getNewsList( isExist, pgNum, pgSize)
    setData(res || [])
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      ...
      <div className="flex flex-col  mx-[155px] md:mx-0 ">
        ...
        {
          loading?<Loading className="h-[22rem] " />:<ArticleList cateId={isExist} data={data} />
        }
