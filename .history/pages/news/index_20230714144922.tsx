    ...
    <div className=" w-container md:w-full md:mt-8 md:px-3">
      {!!data.length &&
        data.map((v, i) => {
          return (
            <>
             { isMobile() ? null : <div className="mt-5 mb-5 border-t-2 text-sk border-gray-1" />}
            <div
              key={`data${i}`}
            ...
            >
              ...
              <div className="flex flex-col justify-between md:ml-[10px]">
                <div className="">
                  ...
                  <time className="inline-block md:py-0 text-[14px] md:text-[12px]  text-gray-2">
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      ...
      <div className="flex flex-col  mx-[155px] md:mx-0 ">
        <div className=" flex flex-wrap md:ml-5  bg-red-200 md:mr-[2.5 md:mx-0 rem] mt-10 md:ml-[20px] rounded-lg shadow-lg justify-between">
          {newsType.map((e, index) => {
            return (
              <div
                key={`type_${e.id}`}
                className={`w-[360px] h-[12.75rem]  rounded-lg shadow-lg bg-red-400  md:mr-[20px] ${index === 2 ? 'md:w-full md:mt-5  ' : 'md:w-[10.625rem] '
                  }`}
              >
        ...
        <div onClick={()=>console.log('rdsa')} >
        <img className="h-[10px] " src={'/images/date_positive.svg'}></img>
        <img className="h-[10px] " src={'/images/date_reverse.svg'}></img>
