...
export default function Index() {
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex ">
        <div className=" max-w-xs w-1/3  ml-[9.5rem] mt-10 mx-10 bg-white shadow-lg h-[12.75rem]  rounded-lg  sm:space-y-0 ">
        ...
        <div className="max-w-sm w-1/3 ml-[9.5rem] mt-10 mx-10 bg-white shadow-lg h-[12.75rem]  rounded-lg  sm:space-y-0 ">
          <div className="w-full h-[3.75rem] p-4 bg-green-1 shadow-lg  rounded-lg text-white">
            数字双碳
          </div>
          <div className="flex justify-between w-full p-2">
