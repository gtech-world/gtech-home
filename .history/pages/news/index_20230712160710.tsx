...
export default function Index() {
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      ...
      {newsType.map((e)=>{
        return  <div className="flex flex-wrap w-[75rem] md:w-[21.9375rem] mx-40 md:mx-5 rounded-lg shadow-lg">
        <div className="w-[22.5rem] h-[12.75rem] md:w-[10.625rem] rounded-lg shadow-lg   ">
