...
export default function Index() {
  ...
  return(
    <HeaderLayout headerProps={headerProps}>
      <div>
        <div className='max-w-sm px-6 ml-[9.5rem] mt-10 mx-10 bg-gray-700 shadow-lg h-[12.75rem] w-[22.5rem] rounded-xl sm:flex sm:space-y-0 sm:space-x-6'>
          <div className="w-full h-[6.75rem] bg-cyan-200">数字双碳</div>
        </div>
      </div>
      {/* <Top />
