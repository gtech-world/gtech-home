...
export default function Index() {
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex mt-10 w-[75rem] md:w-[21.9375rem] whitespace-pre-line  mx-[155px] md:ml-[20px]  rounded-lg shadow-lg justify-between ">
        {newsType.map((e) => {
          return (
            <div
              key={`type_${e.id}`}
            ...
            >
              <div className="shadow-lg  rounded-t-md md:w-[170px]  bg-green h-[4.25rem] flex items-center whitespace-normal ">
