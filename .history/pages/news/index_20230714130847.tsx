                  ...
                  {e.children.map((item: NewsTypesController.ListRecord) => {
                    ...
                    return (
                      ...
                      onClick={()=>setSelected(item)}
                        className={` ${selected.typeName === item.typeName && 'text-[#29953A] text-[14px]  bg-[#29953A1A]  '} bg-[#E9E9E9] min-w-[20px] h-[38px] flex items-center ml-5 mt-5 rounded-[0.25rem] px-[1rem]`}
                      >
                        {item.typeName}
                      </div>
                    );
