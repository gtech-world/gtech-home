          ...
          {newsType.map((e, index) => {
            ...
            return (
              <div
                ...
                className={`w-[360px] h-[12.75rem]  rounded-lg shadow-lg  md:mr-[20px] ${index === 2 ? 'md:w-full md:mt-5 md:h-full' : 'md:w-[10.625rem]'
                  }`}
              >
                <div className={`shadow-lg  rounded-t-md  bg-green h-[4.25rem] flex items-center
               ${index === 2 ? 'md:w-full md:mt-5 md:h-full' : 'md:w-[10.625rem]'}
              `}>
