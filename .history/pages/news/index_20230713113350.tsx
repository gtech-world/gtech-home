...
export default function Index() {
  ...
  console.log("valuevalue", data,loading);
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "title",
      width: "14rem",
      render: (text: string) => <div className=" mr-[400px] ">{text}</div>
  ...
  console.log('tableDataTotal.current', tableDataTotal.current);
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      ...
      <div className="flex flex-col  mx-[155px] md:mx-0">
        ...
        <div className="mt-5 ">
          {data.map((e: any) => {
            return <div key={`list_${e.id}`} className="flex flex-row mt-5">
              <img className=" w-[310px] h-[200px] md:w-[118px] md:h-[78px]" src='https://mmbiz.qpic.cn/mmbiz_jpg/DQUwqx2bH15GbMu8PU0kGXj8AAWqVIKMsPqnFjhq56jDIicHdpvZJ9ZZud3GAVeNV9NJu4bcMEtib0nZHAUmZaNA/0?wx_fmt=jpeg'></img>
              <div className=" ml-[32px]">
                <div>
                  {e.title}
                </div>
                {e.newsType}  2023-03-01 17:08
                <div>
                  {e.digest}
                </div>
                <div>
