...
export default function Index() {
  ...
  return (
    <HeaderLayout headerProps={headerProps}>
      <div className="flex w-44 bg-slate-600">
        <div className="max-w-sm  ml-[9.5rem] mt-10 mx-10 bg-white shadow-lg h-[12.75rem]  rounded-lg  sm:space-y-0 ">
          <div className="w-full h-[3.75rem] p-4 bg-green-1 shadow-lg  rounded-lg text-white">
            数字双碳
          </div>
          <div className="flex justify-between w-full p-2">
            <div className="flex items-center justify-between w-32 h-10 px-2 rounded-lg shadow-lg bg-gray-1">
              数字碳知识库
            </div>
            <div className="flex items-center justify-between w-32 h-10 px-2 rounded-lg shadow-lg bg-gray-1">
              数字碳知识库
        ...
        <div className="max-w-sm  ml-[9.5rem] mt-10 mx-10 bg-white shadow-lg h-[12.75rem] rounded-xl  sm:space-y-0 ">
